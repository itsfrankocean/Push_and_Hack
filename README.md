...
광운대학교 소프트웨어학부 졸업작품 (2025.12 ~ 2026.06)
...
| 이름 | 역할 |
|------|------|
| 안태우 | 총알 로직 구현, URP 2D 광원·노멀맵·셰이더, 픽셀아트 타일맵 |
| 허은빈 | UI 구현 |
| 심정환 | 맵 제작, 사운드, 기능 추가 |
...
GitHub에는 최종 소스코드만 업로드되어 있으며, 개발 히스토리는 Unity Cloud에서 관리되었습니다.
...
본 프로젝트는 Unity Version Control로 관리되어 GitHub에는 최종 소스코드만 업로드되어 있습니다.
...
© 2026 Push & Hack Team. All rights reserved.
